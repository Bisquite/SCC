...
<body id="page1">
   <div id="main">
      ...
      <div id="header">
      	<div class="row-1">
         	<div class="logo"><a href="index.php"><img alt="" src="<?php echo base_url();?>images/logo.jpg" /></a></div>
            <ul class="top-links">
         ...
         <div class="row-2">
            ...
            <form action="" id="search-form">
            	<fieldset>
               	<input type="text" value="" class="text" /><input type="submit" value="" class="submit" />
               </fieldset>
            </form>
         </div>
         <div class="row-3">
