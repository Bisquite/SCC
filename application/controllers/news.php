...
class News extends CI_Controller {
   ...
   public function index() {
       redirect('news/view_recent_news');
   } 
   ...
   * ------------------------------------------*/
   ...
   public function enter_news() {
   	...
   	$this->form_validation->set_rules('content_text', 'Content text', 'required|min_length[1]|max_length[50000]');
   	...
   	if ($this->form_validation->run() == FALSE) { // First load, or problem with form
   		$data['headline_text'] = array('name' => 'headline_text', 'id' => 'headline_text', 'value' => set_value('headline_text', ''));
   		$data['content_text'] = array('name' => 'content_text', 'id' => 'content_text', 'value' => set_value('content_text', ''));
